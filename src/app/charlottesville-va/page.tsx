...
export const metadata: Metadata = {
  title: 'Blue Ridge Estate Paving in Charlottesville, VA | Premium Asphalt',
  description: 'Top-rated asphalt paving in Charlottesville, VA. Get an instant AI Satellite Scan for your commercial or residential project.',
}
    ...
    <main className="min-h-screen bg-slate-950 text-white pb-20">
      <div className="relative pt-32 pb-20 px-6 max-w-7xl mx-auto text-center border-b border-white/5">
        ...
        <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-8 leading-[1.1] uppercase">
          APPALACHIAN PAVING IN <span style={{color:'var(--powerhouse-red)'}}>CHARLOTTESVILLE, VA</span>
        </h1>
        <p className="text-xl text-slate-400 font-light max-w-3xl mx-auto mb-6">
          Serving the entire Charlottesville, VA corridor from ${city.landmark} to ${city.terrain}.
        </p>
